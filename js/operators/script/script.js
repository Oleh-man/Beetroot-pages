...
// let secondDigit = Math.floor(yourNum / 10) % 10;
// let thirdDigit = Math.floor(yourNum / 100);
// alert(`${firstDigit}${secondDigit}${thirdDigit}`);

// maximum

// 1 
let deposit = +prompt('Enter your deposit');
let mounths = +prompt('Enter number of mounths');
let yearFee = (deposit / 100) * 5;
let clientsFee = (yearFee / 12) * mounths;
alert(clientsFee.toFixed(2));
